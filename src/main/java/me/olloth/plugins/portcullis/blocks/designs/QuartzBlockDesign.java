...
public class QuartzBlockDesign extends GenericBlockDesign {
	...
	public QuartzBlockDesign(int textureId) {
		...
		top1.addVertex(1, 0.5F, 1.5F, 0.5F); 
		...
		top2.addVertex(1, 0.5F, 1.5F, 0.5F); 
		...
		top3.addVertex(1, 0.5F, 1.5F, 0.5F); 
		...
		top4.addVertex(1, 0.5F, 1.5F, 0.5F); 
		...
		top5.addVertex(1, 0.5F, 1.5F, 0.5F); 
		...
		bottom1.addVertex(1, 0.5F, 0F, 0.5F); 
		...
		bottom2.addVertex(1, 0.5F, 0F, 0.5F); 
		...
		bottom3.addVertex(1, 0.5F, 0F, 0.5F); 
		...
		bottom4.addVertex(1, 0.5F, 0F, 0.5F); 
		...
		bottom5.addVertex(1, 0.5F, 0F, 0.5F); 
